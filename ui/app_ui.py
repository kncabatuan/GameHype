...
class AppUI:
    ...
    def create_main_header(self) -> None:
        ...
        main_label = tk.Label(main_label_frame, text="Welcome to GameHype!", font=("Arial", 18))
    ...
    def create_status_display(self) -> None:
        ...
        self.status_display = tk.Label(status_display_frame, text=self.controller.display, font=("Arial", 12))
    ...
    def create_image_display(self) -> None:
        ...
        image_display_header = tk.Label(image_display_frame, text="Game:", font=("Arial", 12))
